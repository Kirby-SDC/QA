...
export const reportQuestion = `http://localhost:3000/qa/questions/${Math.floor(Math.random() * 1000000) + 1}/helpful`
export const helpfulAnswer=`http://localhost:3000/qa/answers/${Math.floor(Math.random() * 1000000) + 1}/helpful`
export const reportAnswer=`http://localhost:3000/qa/answers/${Math.floor(Math.random() * 1000000) + 1}/helpful`